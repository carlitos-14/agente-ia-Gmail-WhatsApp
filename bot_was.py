"""
bot_was.py — Agente de WhatsApp. Usa supabase_client.py compartido.
"""
...
from supabase_client import (
    guardar_cita, obtener_ultimo_event_id, obtener_event_id_por_fecha,
    obtener_todas_citas_cliente, eliminar_cita, contar_citas_futuras,
    MAX_CITAS_ACTIVAS
)
...
def procesar_mensaje(phone: str, texto: str, msg_id: str) -> str:
    ...
    if accion == "AGENDAR":
        ...
        if contar_citas_futuras(phone=phone) >= MAX_CITAS_ACTIVAS:
        ...
        eliminar_cita(event_id=event_id_actual, phone=phone)
        ...
        guardar_cita(event_id=new_event_id, fecha_cita=fecha, phone=phone)
        return f"{respuesta}\n\n📅 *{fmt_fecha(fecha)}*"
