...
MAX_CHARS = 6000  # Límite para no saturar el contexto de la IA


def load_company_context(path: str = PDF_PATH) -> str:
    """
    Lee el PDF de documentación y devuelve el texto extraído.
    Si no existe o falla, devuelve cadena vacía (el agente sigue funcionando).
    """
